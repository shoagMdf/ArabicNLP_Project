...
from data_preparation import analyze_function_words
from data_preparation import analyze_punctuation
...
def save_confusion_matrix_plot(y_true, y_pred, model_name, embedding_name):
    ...
    BASE_DIR = globals().get(
        "BASE_DIR",
        r"C:\pycharmCodes\NLP\Githup_NLP\Githup\results\figures"
    )
